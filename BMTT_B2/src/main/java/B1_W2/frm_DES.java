...
public class frm_DES extends javax.swing.JFrame {
    ...
    private void btn_EncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EncryptActionPerformed
        ...
        } catch(HeadlessException | InvalidKeyException | NoSuchAlgorithmException | InvalidKeySpecException | BadPaddingException | IllegalBlockSizeException | NoSuchPaddingException e) {
    ...
    private void saveToFile(String content){
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            try (FileWriter fileWriter = new FileWriter(fileChooser.getSelectedFile() + ".txt")){
                ...
                JOptionPane.showMessageDialog(this, "Err Saving File" + e.getMessage());
            }
        }
    }
    /**
