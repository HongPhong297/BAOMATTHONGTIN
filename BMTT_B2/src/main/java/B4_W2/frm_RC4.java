...
public class frm_RC4 extends javax.swing.JFrame {
    ...
    private void btn_DecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DecryptActionPerformed
        // TODO add your handling code here:
        try {
            String ciphertext = txt_plaintext.getText();
    ...
    /**
     * Chuyển đổi chuỗi thập lục (hex) thành mảng byte.
     *
     * @param s Chuỗi thập lục
     * @return Mảng byte tương ứng
     */
    private static byte[] hexStringToByteArray(String s) {
        // Tính chiều dài mảng byte
        int len = s.length();
    ...
    /**
     * Chuyển đổi mảng byte thành chuỗi thập lục (hex).
     *
     * @param bytes Mảng byte
     * @return Chuỗi thập lục tương ứng
     */
    private static String bytesToHexString(byte[] bytes) {
        // Tạo đối tượng xây dựng chuỗi
        StringBuilder sb = new StringBuilder();

        // Chuyển đổi từng byte thành chuỗi thập lục
        for (byte b : bytes) {
