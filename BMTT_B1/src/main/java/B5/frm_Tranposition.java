...
public class frm_Tranposition extends javax.swing.JFrame {
    ...
    private void btn_EncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EncryptActionPerformed
        ...
        try {
            ...
            int f[] = parseKey(key);
            int d = f.length;
            TranspositionCipher tc = new TranspositionCipher(d, f);
    ...
    // Loại bỏ khoảng trắng không cần thiết và chia chuỗi dựa trên dấu phẩy
    String[] parts = key.trim().split("\\s*,\\s*");
    int[] result = new int[parts.length];

    // Chuyển đổi từng phần từ chuỗi sang số nguyên
